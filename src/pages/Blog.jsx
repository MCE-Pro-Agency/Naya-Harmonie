...
import { ARTICLES, CATEGORIES } from '../data/articles'; // ✅ Import centralisé
        ...
        <section className="py-12 lg:py-20 bg-ivoire">
          <div className="max-w-7xl mx-auto px-6 lg:px-10">
            <div className="reveal">
              ...
              <Link to={`/article/${featured.id}`} className="grid md:grid-cols-2 gap-8 lg:gap-12 items-center group cursor-pointer">
            ...
            <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-8">
              {filtered.map((a, i) => (
                <Link
                  key={a.id}
                  to={`/article/${a.id}`}
                  className={`group cursor-pointer ${i === 1 ? 'md:mt-8' : ''}`}
